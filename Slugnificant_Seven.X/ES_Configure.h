...
#define TIMER2_RESP_FUNC  PostTrackService
...
#define TRACK_SERVICE_TIMER  2
#define BEACON_SERVICE_TIMER 3
#define HSM_TIMER_1          4
#define HSM_TIMER_2          5
#define HSM_TIMER_3          6
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "TrackService.h"
// the name of the Init function
#define SERV_3_INIT InitTrackService
// the name of the run function
#define SERV_3_RUN RunTrackService
// How big should this services Queue be?
